...
//  в объекте data. Они содержат массив с данными о магазинах, где
//  указана длина и ширина помещения; высоту помещения; стоимость отопления
...
function isBudgetEnough(data) {
  ...
  for (let i = 0; i > data['shops'].length; i++) {
    result +=
      data['shops'][i]['width'] * data['shops'][i]['length'] * data['height'];
  }
  if (result * data['moneyPer1m3'] >= data['budget']) {
